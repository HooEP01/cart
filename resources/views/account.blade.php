                                            ...
                                            <div class="row">
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="account-username" name="userName" placeholder="Username" value="{{$account->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="account-name">Name</label>
                                                        <input type="text" class="form-control" id="account-name" name="name" placeholder="Name" value="{{$account->name}}">
                                                    </div>
                                                </div>
                                                <div class="col-12 col-sm-6">
                                                    <div class="form-group">
                                                        <label for="account-e-mail">E-mail</label>
                                                        <input readonly type="email" class="form-control" id="account-e-mail" name="userEmail" placeholder="Email" value="{{$account->email}}">
                                                    </div>
                                                </div>
                                                <div class=" col-12 col-sm-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12 mt-75">
                                                    <div class="alert alert-warning mb-50" role="alert">
                                                        <h4 class="alert-heading">Your email is not confirmed. Please check your inbox. <a href="javascript: void(0);" class="alert-link">Resend confirmation</a></h4>
