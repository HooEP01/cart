                    ...
                    <div class="content-header-left col-md-9 col-12 mb-2" bis_skin_checked="1">
                        <div class="row breadcrumbs-top" bis_skin_checked="1">
                            <div class="col-12" bis_skin_checked="1">
                                <h2 class="content-header-title float-left mb-0">Warranty</h2>
                                        ...
                                        <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1205px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 100px;" aria-label="Name: activate to sort column ascending">Warranty ID</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 107px;" aria-label="Email: activate to sort column ascending">Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 177px;" aria-label="Date: activate to sort column ascending">Inclusion</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 177px;" aria-label="Salary: activate to sort column ascending">Exclusion</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 107px;" aria-label="Status: activate to sort column ascending">Year</th>
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $warranty->id }}</td>
                                                        <td>{{ $warranty->name }}</td>
                                                        <td>{{ $warranty->inclusion }}</td>
                                                        <td>{{ $warranty->exclusion }}</td>
                                                        <td>{{ $warranty->year }}</td>
                                                        <td>
                                                                ...
                                                                function swal(){
                                                                    Swal.fire({
                                                                        ...
                                                                        if (result.isConfirmed) {
                                                                            new function() {
                                                                                window.location.href = "{{route('admin.warranty.delete',['id'=>$warranty->id])}}";
                                                                            };
                                                                        }
                                                                    })
                                                                }
